...
const HomeHero = () => {
    return (<section id="hero" className="min-h-[340px] py-30 flex flex-col items-start justify-center gap-y-8 pr-40 bg-[url('/images/hero-bg.png')]">
        <h1 className="w-full text-left text-[#BDC5DB] bg-ye llow-50">
            Hello, I&apos;m <span className="text-[#61F8D5]">Ajibola Atoyebi</span>.
            <br />
            A Full-Stack Web and Mobile Developer.
        </h1>
        <h6 className="w-1/2 text-left leading-7">
